/* ======================= Service Worker — QR CODE =======================
   ...
   مهم: كل ما تعدّل style.css أو script.js أو أي ملف ثابت آخر، لازم تزيد رقم النسخة
   بالأسفل (v1 -> v2 -> v3 ...) وإلا الزوار العائدون يستمرون يشوفون النسخة القديمة
   المخزّنة بالكاش حتى لو رفعت التعديل الجديد فعليًا على GitHub.
========================================================================= */

const CACHE_NAME = "qrcode-static-v5";
